          ...
          <div className="order-2 lg:order-1">
            <div className="lg:mx-0"> 
              ...
              <p className="mt-8 text-pretty text-lg font-medium text-gray-400 sm:text-xl/8">
                ...
                Creo soluciones web y móviles modernas con React, PHP y Kotlin.
              </p>
            </div>
            ...
            <div className="mt-10 flex items-center gap-x-6">
              <a 
                ...
                className="inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-6 py-3 text-base font-semibold text-blue-300 transition-all duration-300 hover:bg-blue-500/20 hover:border-blue-500/50"
              >
