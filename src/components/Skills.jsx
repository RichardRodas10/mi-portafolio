const skillsData = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Android", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/androidstudio/androidstudio-original.svg" },
    ],
  },
];
...
const Skills = () => {
  return (
    <section id="skills" className="bg-gray-900 py-16 sm:py-32">
